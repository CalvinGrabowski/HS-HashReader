...
public class HashReader {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      while (line.hasNext()) {
         ...
         // breakafter is how many times the chapter is going to see before it starts
         // reading the book
         if (breakAfter > 1) {
            break;
         }
      ...
      // it goes to every word in the book and only takes the alphabetical letters and
      ...
      while (true) {
         ...
         if (answer.equals("no more")) {
            ...
            for (String c : text) {
               // this compares every word in the book to the one that the user is trying to
               // find
               if (c.equals(answer)) {
